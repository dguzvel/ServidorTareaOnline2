        ...
        <table>
          ...
          <?php while($row = $query->fetch()){ { ?> 
            ...
            <tr>
              ...
              <td><?=$row["email"]?></td>
              <td><?=$row["imagen"]?></td>
              <td><a href="./ejercicios/ejercicio10/editar.php?usuario_id=<?=$row["usuario_id"]?>">Editar</a>
                  &nbsp;&nbsp;&nbsp;&nbsp;
                  <a href="./ejercicios/ejercicio10/eliminar.php?usuario_id=<?=$row["usuario_id"]?>">Eliminar</a>
                  &nbsp;&nbsp;&nbsp;&nbsp;
                  <a href="./ejercicios/ejercicio10/detallar.php?usuario_id=<?=$row["usuario_id"]?>">Detallar</a>
              </td>
            </tr>
